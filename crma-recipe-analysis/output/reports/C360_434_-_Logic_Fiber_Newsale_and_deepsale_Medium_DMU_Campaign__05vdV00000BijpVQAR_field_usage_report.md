...
| Field | Used In |
|-------|---------|
| `DPSS_DMU__c` | FORMULA47 (formula) |
| `DPSS_Segment__c` | FILTER9 (filter) |
| `Has_Subscriptions_Actual__c` | FORMULA0_copy0 (formula) |
| `Id` | DROP_FIELDS21 (schema), FORMULA47 (formula), JOIN19 (join), JOIN0 (join), JOIN3 (join) +5 more |
| `Industry__c` | FORMULA87 (formula), FORMULA97 (formula) |
| `Is_DMU__c` | FORMULA47 (formula), FORMULA57 (formula), FORMULA60 (formula) |
| `KurtID__c` | FORMULA23_copy0_copy0 (formula) |
...
| `Name` | DROP_FIELDS21 (schema), FORMULA78 (formula), FORMULA59 (formula) |
...
| `Id` | JOIN20 (join), APPEND2_copy1_copy0 (appendV2), DROP_FIELDS13_copy0_copy0 (schema), DROP_FIELDS14_copy0_copy0 (schema), JOIN3 (join) +2 more |
...
| `Name` | APPEND2_copy1_copy0 (appendV2), DROP_FIELDS13_copy0_copy0 (schema), DROP_FIELDS14_copy0_copy0 (schema), FORMULA59 (formula), FORMULA78 (formula) |
