...
| `Id` | DROP_FIELDS17_copy1 (schema), DROP_FIELDS5 (schema), DROP_FIELDS15 (schema), DROP_FIELDS17_copy0 (schema), JOIN14 (join) +11 more |
| `KurtID__c` | DROP_FIELDS17_copy1 (schema), DROP_FIELDS15 (schema), DROP_FIELDS17_copy0 (schema), DROP_FIELDS17 (schema), DROP_FIELDS18 (schema) +2 more |
