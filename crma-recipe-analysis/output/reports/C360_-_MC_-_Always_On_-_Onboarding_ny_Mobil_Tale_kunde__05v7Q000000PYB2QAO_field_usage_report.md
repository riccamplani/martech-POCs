...
| LOAD_DATASET11 | Agreement__c | connectedDataset | 50 | 5 | 45 | 90% |
| LOAD_DATASET0_copy0 | Agreement__c | connectedDataset | 8 | 3 | 5 | 62% |
...
| Field | Used In |
|-------|---------|
| `COM_CUSTOMER_EDM_RESERVATION__c` | DROP_FIELDS6 (schema), DROP_FIELDS0 (schema) |
| `CreatedDate` | DROP_FIELDS1 (schema), APPEND0 (appendV2) |
| `Id` | DROP_FIELDS6 (schema), DROP_FIELDS5 (schema), DROP_FIELDS0 (schema), DROP_FIELDS17 (schema), APPEND4 (appendV2) +2 more |
| `KurtID__c` | DROP_FIELDS6 (schema), DROP_FIELDS5 (schema), DROP_FIELDS0 (schema), JOIN10 (join), JOIN11 (join) +3 more |
| `MV_FIRST_SALE_DT__c` | FILTER1 (filter), DROP_FIELDS6 (schema) |
| `NEW_MV__c` | DROP_FIELDS6 (schema) |
| `Name` | DROP_FIELDS1 (schema), APPEND0 (appendV2) |
| `StatusKURT__c` | DROP_FIELDS6 (schema) |
| `SubsMobileVoice__c` | FILTER5 (filter), DROP_FIELDS6 (schema), DROP_FIELDS0 (schema) |
...
| `Parameter_6_Value__c` | FORMULA49_copy1 (formula) |
| `Product_Name__c` | FILTER18 (filter), DROP_FIELDS19 (schema), FORMULA35 (formula) |
...
| `Product_Name__c` | FILTER0_copy0 (filter), FORMULA0_copy1 (formula), FORMULA35 (formula) |
...
| `Id` | DROP_FIELDS1 (schema), APPEND0 (appendV2), APPEND4 (appendV2) |
...
| `Parameter_6_Value__c` | DROP_FIELDS1 (schema), APPEND0 (appendV2), DROP_FIELDS23 (schema), FORMULA49_copy1 (formula) |
...
| `Email` | DROP_FIELDS22_copy0_copy0 (schema) |
| `Has_eMail__c` | DROP_FIELDS22_copy0_copy0 (schema) |
| `Id` | DROP_FIELDS22_copy0_copy0 (schema) |
| `IsDeleted` | FILTER20_copy0_copy0 (filter) |
| `Marketing_Cloud_Contact2__c` | DROP_FIELDS22_copy0_copy0 (schema) |
| `Marketing_Cloud_Email_Bounced__c` | DROP_FIELDS22_copy0_copy0 (schema) |
| `Name` | DROP_FIELDS22_copy0_copy0 (schema) |
| `Non_Marketable_Contact__c` | DROP_FIELDS22_copy0_copy0 (schema) |
| `Primary__c` | FILTER20_copy0_copy0 (filter), DROP_FIELDS22_copy0_copy0 (schema) |
