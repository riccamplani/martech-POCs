...
|-----------|--------------|------|-------------|------|--------|-----------|
| LOAD_DATASET0 | Account | connectedDataset | 17 | 16 | 1 | 6% |
| **TOTAL** | | | **17** | **16** | **1** | **6%** |
...
| `Company_Family_Name__c` | FORMULA58 (formula), APPEND0 (appendV2), DROP_FIELDS22 (schema), DROP_FIELDS14_copy0 (schema) |
| `Id` | JOIN10 (join), JOIN0 (join), FORMULA55 (formula), JOIN9 (join), JOIN1 (join) +8 more |
...
| `Mobile_Segment__c` | APPEND0 (appendV2), DROP_FIELDS22 (schema), DROP_FIELDS14_copy0 (schema) |
...
| `NumberOfEmployees` | APPEND0 (appendV2), DROP_FIELDS22 (schema), DROP_FIELDS14_copy0 (schema) |
...
| `SubsMobileVoice__c` | FORMULA44_copy0_copy0 (formula), APPEND0 (appendV2) |
| `TSP_Dealer__c` | FILTER17 (filter), APPEND0 (appendV2), DROP_FIELDS22 (schema), DROP_FIELDS14_copy0 (schema) |
| `mobile_service_segment__c` | FILTER19 (filter), APPEND0 (appendV2) |
