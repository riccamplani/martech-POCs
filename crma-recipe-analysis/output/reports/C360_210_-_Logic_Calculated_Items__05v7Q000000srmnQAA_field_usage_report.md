# C360_210_-_Logic_Calculated_Items__05v7Q000000srmnQAA — Field Usage Report

**Recipe:** C360_210_-_Logic_Calculated_Items__05v7Q000000srmnQAA
**Total nodes:** 402
...
|-----------|--------------|------|-------------|------|--------|-----------|
| LOAD_DATASET7 | Account | connectedDataset | 59 | 17 | 42 | 71% |
...
| Field | Used In |
|-------|---------|
| `Account_Owner_Full_Name__c` | FORMULA39_copy3_copy0 (formula) |
...
| `Id` | DROP_FIELDS25 (schema), APPEND1_copy1 (appendV2), FORMULA51 (formula), FORMULA55 (formula), DROP_FIELDS0_copy0_copy3 (schema) +15 more |
